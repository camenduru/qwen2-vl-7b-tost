...
with torch.inference_mode():
    ...
    model = Qwen2VLForConditionalGeneration.from_pretrained(checkpoint_path, trust_remote_code=True, torch_dtype=torch.bfloat16).cuda().eval()
